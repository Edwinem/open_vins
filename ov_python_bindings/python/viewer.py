...
from render_text import CustomTextWriter2D


def convert_mat44_to_pyrr_format(mat4x4):
    """ Converts a 4x4 homogenous transform to a format the pyrr library will accept.
...
class SLAMViewer(CameraWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.writer = CustomTextWriter2D(self.ctx)
        self.writer.text = "Camera Controls:\n" \
                           "- WASD: Move camera\n" \
                           "- E: Zoom In\n" \
                           "- Q: Zoom out\n" \
                           "- F: Follow/Unfollow camera."
    ...
    def render(self, time: float, frametime: float):
        ...
        for r in self.renderables:
            ...
            r.render(self.prog)
        self.writer.draw((10, 500), length=1, size=20)
